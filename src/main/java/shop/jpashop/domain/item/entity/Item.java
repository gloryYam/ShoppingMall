...
import static shop.jpashop.domain.item.entity.ImageType.DETAIL;
import static shop.jpashop.domain.item.entity.ImageType.MAIN;
...
import shop.jpashop.domain.item.exception.NotEnoughStockException;
